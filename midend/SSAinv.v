...
Proof.
  intros.
  eapply equation_lemma; eauto.
  assert (wf_ssa_function f).
  { unfold reachable in H2.
    destruct H2 as [s0 [t [Hinit Hstar]]].
    exploit ssa_inv1; eauto. intro Hinv.
    inv Hinv ; auto.
  ...
  eapply dom_eq_sdom in Hdom; eauto using peq.
  destruct Hdom as [Hdom1 | Hdom2] ; auto.
  inv Hdom1.
  inv H1.
  ...
  - inv H4.
    ...
    exploit (fn_normalized f H3 pc0 pc); eauto.
    + eapply index_pred_some_nth in KPRED.
      ...
      rewrite PTree.gmap1. unfold option_map. rewrite H.
      auto.
    + congruence.
Qed.
