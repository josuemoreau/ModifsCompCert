...
Extract Constant BPrinters.string_of_fct_ident =>
  "fun x -> Camlcoq.coqstring_of_camlstring (Camlcoq.extern_atom x)".
Extract Constant BPrinters.string_of_var_ident =>
  "fun x -> Camlcoq.coqstring_of_camlstring (ParserUtils.get_name x)".
